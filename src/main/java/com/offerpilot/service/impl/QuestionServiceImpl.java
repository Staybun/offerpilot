...
import com.offerpilot.mapper.QuestionMapper;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question> implements QuestionService {
    ...
    public void batchDeleteQuestions(List<Long> questionIdList) {
        ...
        questionBankQuestionService.remove(Wrappers.lambdaQuery(QuestionBankQuestion.class)
                .in(QuestionBankQuestion::getQuestionId, questionIdList));
        ThrowUtils.throwIf(!this.removeByIds(questionIdList), ErrorCode.OPERATION_ERROR, "批量删除题目失败");
    }
